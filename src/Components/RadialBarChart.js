...
function RadialBarChart({data}){
  ...
  useEffect(() => {
    ...
    svg
      ...
      .style("fill", "black")
      .style("font-size", 8)
      .style("transform", `translateX(${dimensions.width/2}px) translateY(${dimensions.height/2 + 10}px) `)
      ...
      .style("fill", "black")
      .style("font-size", 8)
      .style("transform", `translateX(${dimensions.width/2}px) translateY(${dimensions.height/2 + 20}px) `)
