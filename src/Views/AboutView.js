  ...
  return (
    <div className="about-main">
      <div className="about-header sub-container">
        <h4>
          We create awareness about content diversity in online knowledge spaces{" "}
        </h4>
        <figure>
          <img
            className="about-img"
      ...
      <div className="about-content">
        ...
        <p>
          Humaniki is a project producing an open data set about the gender,
          date of birth, place of birth, and language of content about humans in
          all Wikimedia projects, typically Wikipedia biography articles. Our
          data set comes from Wikidata, the database that feeds Wikipedia, and
          is updated daily. This site shows a few demonstrations of what can be
          done with the open API we've built to serve that information.
        </p>
        ...
        <p>
          ...
          those previous sites were useful to the community, but as proof of
          concepts needed extra architectural work. It was decided that instead
          of improving each one, we would work together in the Wikimedian spirit
          of cooperation.
        </p>

        <p>
          We have also conducted research about the significance of what
          Wikipedia's biography gap represents. That is, gender disparities in
          biographies mirror “traditional” gender-disparity indices (GDI, GEI,
          GGGI and SIGI), and occupational gender, although are most correlated
          to economic measurements. Read our paper{" "}
          <a
        ...
        <p>
          This project started as a personal research interest, and is now
